        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="signin.php" method="post">
              ...
              <div class="row">
              <div class="col-md-6">
              <button class="btn btn-lg btn-google btn-block text-uppercase" name="google_login" type="submit"><i class="fab fa-google mr-2"></i> <a href="#" class="btn-google m-b-20">
                        <img src="google.png" style="width: 80%;height: 50%;">
                        
                    </a></button></div><div class="col-md-6">
              <button class="btn btn-lg btn-facebook btn-block text-uppercase" name="facebook_login" type="submit"><i class="fab fa-facebook-f mr-2"></i>Facebook</button></div></div>
            </form>
          </div>
        </div>
      </div>
